    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content" class="container" >
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Show User <?php echo e($users->id); ?></h5>
                        <table class="table ">
                            <tr>
                                <td><P> Username</P></td>
                                <td><p><?php echo e($users->username); ?></p></td>
                            </tr>
                                <tr>
                                <td><p>Nama</p></td>
                                <td><p><?php echo e($users->name); ?></p></td>
                            </tr>
                                <tr>
                                <td><p>Email</p></td>
                                <td><p><?php echo e($users->email); ?></p></td>
                            </tr>
                                <tr>
                                <td><p>Level</p></td>
                                <td><p><?php echo e($users->level); ?></p></td>
                            </tr>
                        </table>
                    </div>
                </div>
...
<?php /**PATH C:\xampp\htdocs\New folder\KOKERU\resources\views/users/show.blade.php ENDPATH**/ ?>