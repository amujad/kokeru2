...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <table class="table">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $ruangan ?? ''; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td><?php echo e($key + 1); ?></th>
                        <td><?php echo e($value->nama); ?></td>
                        <td><?php echo e($value->cs_id); ?></td>
                        <td><?php echo e($value->status); ?></td>
                        <td>
                            <a href="/ruangan/<?php echo e($value->idruangan); ?>" class="btn btn-info">Show</a>
                            <a href="/ruangan/<?php echo e($value->idruangan); ?>/edit" class="btn btn-primary">Edit</a>
                            <form action="/ruangan/<?php echo e($value->idruangan); ?>" method="POST" onsubmit="return confirm('Yakin ingin menghapus?')">
                                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\New folder\KOKERU\resources\views/ruangan/index.blade.php ENDPATH**/ ?>